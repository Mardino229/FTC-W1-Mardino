            ...
            <div className="flex items-center justify-center px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-7xl w-full">
                    ...
                    <div
                        data-id="feature1"
                        ref={addToRefs}
                        className={`rounded-2xl pb-10 shadow-[inset_0px_0.5px_0px_0px_rgba(255,255,255,0.5),_0px_-2px_40px_0px_rgba(187,155,255,0.15),_0px_-2px_10px_0px_rgba(233,223,255,0.3)] ${
                            visibleElements["feature1"] ? "animate-fade-right" : ""
                        }`}
                    >
                        ...
                        <div className="flex md:px-10 px-9 gap-3 flex-col justify-between">
                            ...
                            <a href="#" className="underline pt-4 md:text-lg text-base font-medium">
                                View dashboard
                            </a>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        ref={addToRefs}
                        className={`rounded-2xl pb-10 shadow-[inset_0px_0.5px_0px_0px_rgba(255,255,255,0.5),_0px_-2px_40px_0px_rgba(187,155,255,0.15),_0px_-2px_10px_0px_rgba(233,223,255,0.3)] ${
                            visibleElements["feature2"] ? "animate-fade-left" : ""
                        }`}
                    >
                        <img src={token} alt="" />
                        <div className="flex md:px-10 px-9 gap-3 flex-col justify-between">
                    ...
                    <div data-id="feature3"
                         ref={addToRefs} className={`${
                        visibleElements["feature3"] ? "animate-fade-up" : ""
                    } md:col-span-2 flex items-center flex-col md:flex-row gap-8 justify-between rounded-2xl py-8 shadow-[inset_0px_0.5px_0px_0px_rgba(255,255,255,0.5),_0px_-2px_40px_0px_rgba(187,155,255,0.15),_0px_-2px_10px_0px_rgba(233,223,255,0.3)]`}>
                        <div className="flex-1 md:max-w-xl">
                            ...
                            <div className="flex md:px-10 px-9 pb-8 gap-3 flex-col justify-between">
                                ...
                                <p className="text-sm font-normal">
                                    ...
                                    makes it easy to collaborate and ensure that your data is
                        ...
                        <div className="md:px-10 px-9">
                            <img
                                src={image}
                                className="rounded-2xl shadow-[inset_0px_0.5px_0px_0px_rgba(255,255,255,0.5),_0px_-2px_40px_0px_rgba(187,155,255,0.15),_0px_-2px_10px_0px_rgba(233,223,255,0.3)]"
                                alt=""
                            />
                        </div>
                    </div>
