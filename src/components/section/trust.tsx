        ...
        <section className="py-10 px-5">
            ...
            <div className="max-w-6xl mx-auto text-[rgba(255,255,255,0.8)] flex flex-col gap-10 mb-3 text-center">
                ...
                <div className="flex flex-wrap md:justify-around justify-center items-center gap-6 grayscale opacity-70">
                    <img src={dell} alt="Dell" className="h-6" />
                    <img src={zendesk} alt="Zendesk" className="h-6" />
                    <img src={rakuten} alt="Rakuten" className="h-6" />
                    <img src={pacific} alt="Pacific Funds" className="h-6" />
                    <img src={ncr} alt="NCR" className="h-6" />
                    <img src={lactice} alt="Lattice" className="h-6" />
                    <img src={Ted} alt="TED" className="h-6" />
                </div>
            </div>
